<template>
	<view>
		<hx-navbar title="我的储藏柜" :fixed="true" barPlaceholder="hidden" transparent="auto" :color="['#ffffff','#ffffff']"
		...
		<view class="content">
			<view class="top">
				<image src="../../static/tab1/storage_top_bg.png" mode="" style="width: 100%;"></image>
			</view>
			<view>
